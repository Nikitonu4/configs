# Generated by Powerlevel10k configuration wizard on 2022-04-04 at 10:10 MSK.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 58020.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, vertical separators, sharp heads, round tails, 1 line, sparse, few icons,
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=230
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=063
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=117
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=196
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=228
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PRECISION=159
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=025
